...
1. Regresja Jednowymiarowa (Y vs X) 
...
2. Regresja Wielokrotna (Y vs X1...X6)
...
1. *Univariate Regression (Y vs. X)*

  *a) Visualization: Analyzing scatter plots.*

  *b) Polynomial Regression: Building models up to $n \le 5$ degree and selecting the optimal polynomial degree.*

  *c) Diagnostics: Statistical tests and diagnostic plots.*

  *d) Linear Regression with Transformation: Modeling based on absolute values $|X - a_n|$ ​​with manual selection of nodes.*

  *e) Diagnostics: Statistical tests and diagnostic plots.*

  *f) Validation: Splitting the data into a training set (70%) and a test set (30%), and comparing the models using the sum of squared errors (SSE).*

2. *Multiple Regression (Y vs. X1...X6)*

  *a) Modeling: Building a full linear regression model for multiple explanatory variables.*

  *b) Diagnostics: Statistical tests and diagnostic plots.*

  *c) Collinearity Analysis: Examining linear relationships between explanatory variables.*

  *d) Variable Selection: Model optimization using backward elimination and forward selection for up to two variables.*

  *e) Validation: Splitting the data into a training set (70%) and a test set (30%), and comparing the models using the sum of squared errors (SSE).*
